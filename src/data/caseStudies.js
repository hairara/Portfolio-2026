export const caseStudies = {
  'anesthesia-module': {
    ...
    overview:
      'From first insight to final asset — end-to-end creative direction across every discipline that shapes how a brand lives in the world.',
    problems: [
      {
        number: '01',
        title: 'Documentation',
    ...
    goals: [
      'More faster documentation',
      'Data capture more actual and accurate',
      'Reduce time for documentation of anesthesia',
    ],
    goalImages: [null, null, null],
    solutions: [
      {
        number: '01',
        title: 'Validate and POC Existing Design Proposal',
        description:
          'Sebelumnya sudah ada proposal konsep design dari designer sebelumnya, namun setelah handover, saya mencoba melakukan POC ulang dengan stakeholder, harapan nya untuk mengetahui bagaimana problems dan needs user sebenarnya. Selain itu saya juga melakukan short discussion dengan product manager terkait design konsep ini, yang menghasilkan beberapa key point di atas:\n\n1.1. Terlalu banyak scrolling\n1.2. design layout terlalu banyak whitespace\n1.3. Terlalu banyak touch point to click',
        image: null,
      },
      {
        number: '02',
        title: 'Simplify Design with Utilize Form Existing',
        description:
          '1.1. Terlalu banyak scrolling\n1.2. design layout terlalu banyak whitespace\n1.3. Terlalu banyak touch point to click',
        image: null,
      },
      {
        number: '03',
        title: 'Mapping Device to Connect the Flowchart',
        description:
          '1.1. Terlalu banyak scrolling\n1.2. design layout terlalu banyak whitespace\n1.3. Terlalu banyak touch point to click',
        image: null,
      },
    ...
    validation: [
      {
        label: 'Scenario 01',
        title: 'Apakah pencatatan documentation saat ini sudah lebih mudah dan cepat dilengkapi?',
        description:
          'Positioning, narrative, and visual language that gives a brand a clear reason to exist — and a clear place in culture.',
      },
      {
      ...
      {
        label: 'Scenario 03',
        title: 'Seberapa jauh perbedaan waktu pengisian dokumentasi saat ini dengan sebelumnya?',
        description:
          'Positioning, narrative, and visual language that gives a brand a clear reason to exist — and a clear place in culture.',
      },
    ],
