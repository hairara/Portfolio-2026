<template>
  ...
  >
    ...
    <a
      href="#"
      class="flex items-center gap-2 border border-border rounded-full px-4 py-[7px] shrink-0 hover:border-accent transition-colors duration-200"
    >
...
<style scoped>
.anim-nav {
  animation: slide-down 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.05s both;
}
